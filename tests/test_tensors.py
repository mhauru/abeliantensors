...
tensorclasses = (Tensor, TensorZ2, TensorU1, TensorZ3)


# The point of this trivial-seeming fixture is that several other fixtures that
# take tensorclass as input all receive the same object.
@pytest.fixture(scope="module", params=tensorclasses)
