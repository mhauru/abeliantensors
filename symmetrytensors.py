...
class TensorZQ(AbelianTensor):
    ...
    def __init__(self, shape, *args, qhape=None, qodulus=None, **kwargs):
        ...
        return super(TensorZQ, self).__init__(
    ...
    def initialize_with(
        ...
        qodulus = cls.qodulus
        return super(TensorZQ, cls).initialize_with(
    ...
    def from_ndarray(
        ...
        if qhape is None:
            qhape = cls.shape_to_qhape(shape)
        qodulus = cls.qodulus
        return super(TensorZQ, cls).from_ndarray(
    ...
    def split_indices(self, indices, dims, qims=None, dirs=None):
        ...
        return super(TensorZQ, self).split_indices(
